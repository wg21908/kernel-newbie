...
- Emulate v0.01 of the Linux Kernel (coming soon): Using a Emulator, I want to mimic the machine that Linus Torvolds stood up with the 1st version of the Linux Kernel

## What This Repo Covers

- Finding beginner-friendly issues in kernel-adjacent projects.
- Using mailing-list based patch workflow (`git format-patch`, `git send-email`).
